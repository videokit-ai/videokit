...
namespace NatML.VideoKit.Editor {
    ...
    internal sealed class VideoKitRecorderEditor : Editor {
        ...
        private SerializedProperty cameraManagerProperty;
        ...
        private void OnEnable () {
            ...
            cameraManagerProperty = serializedObject.FindProperty(@"cameraManager");
            ...
            if (videoOptions && videoMode != VideoMode.None) {
                ...
                switch (videoMode) {
                    ...
                    case VideoMode.CameraDevice:
                        EditorGUILayout.PropertyField(cameraManagerProperty);
                        break;
                }
            }
            // Events
