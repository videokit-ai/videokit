...
namespace NatML.VideoKit {
    ...
    public sealed class VideoKitAudioManager : MonoBehaviour, IVideoKitDeviceManager<AudioDevice> {
        ...
        private static AudioDevice GetDefaultAudioDevice () {
            // Create query
            var query = new MediaDeviceQuery(MediaDeviceCriteria.AudioDevice, configureAudioSession: true);
            // Return
