...
namespace VideoKit.Internal {
    ...
    public static class VideoKit {
        ...
        [DllImport(Assembly, EntryPoint = @"VKTCreateMP4Recorder")]
        ...
        [DllImport(Assembly, EntryPoint = @"VKTCreateHEVCRecorder")]
        ...
        [DllImport(Assembly, EntryPoint = @"VKTCreateGIFRecorder")]
        ...
        [DllImport(Assembly, EntryPoint = @"VKTCreateWAVRecorder")]
        ...
        [DllImport(Assembly, EntryPoint = @"VKTCreateWEBMRecorder")]
        ...
        #region --VKTDevice--
        [DllImport(Assembly, EntryPoint = @"VKTReleaseDevice")]
