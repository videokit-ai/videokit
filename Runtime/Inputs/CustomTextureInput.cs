...
namespace NatML.VideoKit.Inputs {
    ...
    internal sealed class CustomTextureInput : IDisposable {
        ...
        public CustomTextureInput (IMediaRecorder recorder, IClock clock, Texture texture) : this(TextureInput.CreateDefault(recorder), clock, texture) { }
        ...
        /// <param name="recorder">Media recorder to receive video frames.</param>
        /// <param name="generator">Texture to record from.</param>
        public CustomTextureInput (IMediaRecorder recorder, Texture texture) : this(recorder, default, texture) { }
