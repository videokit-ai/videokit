...
namespace NatML.VideoKit.Inputs {
    ...
    public sealed class AudioDeviceInput : IDisposable {
        ...
        private void OnSampleBuffer (SampleBuffer sampleBuffer) {
            UnityEngine.Debug.Log($"Audio device input received {sampleBuffer.audioBuffer.sampleBuffer.Length} samples");
             recorder.CommitSamples(
