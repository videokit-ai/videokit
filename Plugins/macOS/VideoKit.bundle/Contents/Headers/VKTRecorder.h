...
*/
VKT_BRIDGE VKT_EXPORT VKTStatus VKT_API VKTCreateMP4Recorder (
    const char* path,
    int32_t width,
    int32_t height,
    float frameRate,
...
/*!
 @function VKTCreateHEVCRecorder
 ...
 @returns Recorder creation status.
 */
VKT_BRIDGE VKT_EXPORT VKTStatus VKT_API VKTCreateHEVCRecorder (
    const char* path,
    int32_t width,
    int32_t height,
    float frameRate,
...
/*!
 @function VKTCreateWEBMRecorder
 ...
 Output media recorder.
*/
VKT_BRIDGE VKT_EXPORT VKTStatus VKT_API VKTCreateWEBMRecorder (
    const char* path,
    int32_t width,
    int32_t height,
    float frameRate,
...
/*!
 ...
 @returns Recorder creation status.
*/
VKT_BRIDGE VKT_EXPORT VKTStatus VKT_API VKTCreateGIFRecorder (
    const char* path,
    int32_t width,
    int32_t height,
    float delay,
...
/*!
 ...
 Output media recorder.
*/
VKT_BRIDGE VKT_EXPORT VKTStatus VKT_API VKTCreateWAVRecorder (
    const char* path,
    int32_t sampleRate,
    int32_t channelCount,
    VKTRecorder** recorder
